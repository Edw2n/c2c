...
SCHEMA_NAME = "public"
TABLE_NAME = ["GroundTruth", "ProductInfo", "QC", "User", "DatasetInfo", "Features", "Transaction", "Object", "TransactionProduct"]
ALL_COLUMNS = [[   
                ...
                [
                    'tx_id', 'tx_date', 'dataset_id', 'img_id_list', 'buyer_id', 'seller_id', 'price', 'txp_id'
                ],
                [
                    'gt_object_id', 'gt_object'
                ],
                [
                    'txp_id', 'availability', 'buyer_defined_dataset_name', 'product_path'
                ]
            ]
...
FK_LIST = [('Features','img_id', 'GroundTruth', 'img_id'),
           ...
           ('TransactionProduct', 'txp_id', 'Transaction', 'txp_id')
           ]
...
TRANSACTIONPRODUCT_COLUMNS_INFO = {
    "txp_id":     "bigint GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY",
...
ALL_COLUMNS_INFO = [GROUNDTRUTH_COLUMNS_INFO, PRODUCTINFO_COLUMNS_INFO, 
                    ...
                    OBJECT_COLUMNS_INFO,TRANSACTIONPRODUCT_COLUMNS_INFO ]
